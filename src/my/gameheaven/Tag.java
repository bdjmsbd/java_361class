...
public class Tag {
	...
	final static String alert = "ALERT"; // 공백

	final static String change = "CHANGE"; // 회원정보변경
	final static String rank = "RANK"; // 전적조회(전체회원)
	final static String over = "OVER"; // 중복확인
	final static String view = "VIEW"; // 회원정보조회
	final static String cuser = "CUSER"; // 접속유저
	final static String search = "SEARCH"; // 전적조회(한명)
	final static String pexit = "PEXIT"; // 프로그램종료
	final static String omok = "OMOK"; // 오목
	final static String win = "WIN"; // 승리
	final static String lose = "LOSE"; // 패배
	final static String record = "RECORD"; // 전적업데이트
